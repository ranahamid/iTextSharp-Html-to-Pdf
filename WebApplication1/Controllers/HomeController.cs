...
namespace WebApplication1.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var builder = new PdfBuilder(list, Server.MapPath("/Views/Shared/Pdf.cshtml"));
            var html= builder.GetPdf();
          return  getP(html);
          
        }
        public FileContentResult getP(string html)
        {
            ...
            using (var ms = new MemoryStream())
            {
                ...
                using (var doc = new Document())
                {
                    ...
                    using (var writer = PdfWriter.GetInstance(doc, ms))
                    {
                        ...
                        //Create a new HTMLWorker bound to our document ---RH
    ...
    public class PdfBuilder
    {
        ...
        public PdfBuilder(List<int> post, string file)
        {
            _post = post;
            _file = file;
        }
